	...
	protected void initTimeline() {
		...
		setTimeline(new Timeline(
				new KeyFrame(Duration.millis(0),
						...
						new KeyValue(getNode().translateXProperty(), startX,
				...
				new KeyFrame(Duration.millis(600),
						...
						new KeyValue(getNode().translateXProperty(), -25,
								Interpolator.SPLINE(0.215, 0.610, 0.355, 1.000))),
				new KeyFrame(Duration.millis(750),
						new KeyValue(getNode().translateXProperty(), 10,
								Interpolator.SPLINE(0.215, 0.610, 0.355, 1.000))),
				new KeyFrame(Duration.millis(900),
						new KeyValue(getNode().translateXProperty(), -5,
								Interpolator.SPLINE(0.215, 0.610, 0.355, 1.000))),
				new KeyFrame(Duration.millis(1000), new KeyValue(getNode().translateXProperty(), 0,
						Interpolator.SPLINE(0.215, 0.610, 0.355, 1.000)))
